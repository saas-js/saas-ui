...
<ComponentLinks
  theme={{ componentName: 'heading', theme: 'saas-ui' }}
  github={{
    url: 'https://github.com/chakra-ui/chakra-ui/tree/main/packages/layout',
  }}
...
Pass the `noOfLines={1}` prop to render an ellipsis when the heading exceeds the
