...
export const nprogressTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { nprogressAnatomy } from './components/nprogress'

export const theme = extendTheme({
  components: { SuiNprogress: nprogressAnatomy },
})
```
...
<Nprogress variant="custom"> ... </Nprogress>
```
