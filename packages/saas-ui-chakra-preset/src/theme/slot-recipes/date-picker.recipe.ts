...
export const datePickerSlotRecipe = defineSlotRecipe({
  ...
  base: {
    ...
    content: {
      ...
      minW: '18rem',
      color: 'fg',
      '--date-picker-z-index': 'zIndex.layer-3',
    ...
    tableCellTrigger: {
      ...
      '&[data-in-range][data-selected]': {
        ...
        '&[data-range-start]:not([data-range-end])': {
          borderStartRadius: 'control.md',
          borderEndRadius: '0',
        },
        '&[data-range-end]:not([data-range-start])': {
          borderEndRadius: 'control.md',
          borderStartRadius: '0',
        },
      },
      _disabled: {
  ...
  variants: {
    size: {
      xs: {
        root: {
          '--datepicker-input-height': 'sizes.6',
      ...
      sm: {
        root: {
          '--datepicker-input-height': 'sizes.7',
