...
```jsx live=false
import { timelineAnatomy } from '@saas-ui/theme/anatomy'
...
export const timelineTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { timelineAnatomy } from './components/timeline'

export const theme = extendTheme({
  components: { SuiTimeline: timelineAnatomy },
})
```
...
<Timeline variant="custom"> ... </Timeline>
```
