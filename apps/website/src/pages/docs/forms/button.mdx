...
<ComponentLinks
  ...
  github={{ package: 'saas-ui-button' }}
  npm={{ package: '@saas-ui/button' }}
/>
...
<Stack spacing={4}>
  <Stack spacing={4} direction="row" align="center">
    ...
    <Button colorScheme="secondary">Seconary</Button>
  </Stack>
  <Stack spacing={4} direction="row" align="center">
...
value to `solid`, `subtle`, `outline`, `ghost`, `elevated` or `link`.
...
<Info>
  White buttons only work with the `Saas UI` theme on darker colors or in
  darkmode.
</Info>
...
>
  ...
  <Button colorScheme="white" variant="elevated">
    Button
  </Button>
...
<Stack direction="row" spacing={4}>
  <Button rightIcon={<FiArrowRight />} colorScheme="blue" variant="outline">
    Call us
  </Button>
</Stack>
```
