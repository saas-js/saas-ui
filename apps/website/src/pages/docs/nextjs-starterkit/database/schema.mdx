...
Use `yarn db:migrate` to create a new migration. [Learn more about migrations](/docs/nextjs-starterkit/database/migrations).
...
- ID's use [Cuid2](https://github.com/paralleldrive/cuid2), which are secure, collision-resistant ids optimized for horizontal scaling and performance.
