...
export const metadata: Metadata = {
  ...
  description: 'Read the Saas UI Privacy Policy',
}
  ...
  return (
    <Box py={20}>
      <Container maxW="2xl">
        ...
        <Prose>
          <p>
            Saas UI is a product of Saas UI B.V. This privacy policy will
          ...
          <p>Saas UI B.V. collects the following data:</p>
          <ul>
            <li>
          ...
          <p>
            You directly provide Saas UI B.V. with most of the data we collect.
          ...
          <p>
            Saas UI B.V. may also receive your data indirectly from the
            following sources:
          </p>
          <ul>
            <li>Gumroad.com</li>
          ...
          <p>Saas UI B.V. collects your data so that we can:</p>
          <ul>
          ...
          <p>
            When Saas UI B.V. processes your order, it may send your data to,
            and also use the resulting information from, credit reference
            agencies to prevent fraudulent purchases.
          </p>
          <h3>How do we store your data?</h3>
          <p>
            Saas UI B.V. securely stores your data at our infrastructure partner
            Supabase.
          </p>
          <p>
            Saas UI B.V. will keep your contact information as long as your are
            an active customer. Once you terminate your account, we will delete
            your data.
          </p>
          <h3>What are your data protection rights?</h3>
          <p>
            Saas UI B.V. would like to make sure you are fully aware of all of
            your data protection rights. Every user is entitled to the
            following:
          </p>
          <p>
            <strong>The right to access</strong> – You have the right to request
            Saas UI B.V. for copies of your personal data. We may charge you a
            small fee for this service.
          </p>
          <p>
            <strong>The right to rectification</strong> – You have the right to
            request that Saas UI B.V. correct any information you believe is
            inaccurate. You also have the right to request Appulse Holding B.V.
            to complete the information you believe is incomplete.
          </p>
          <p>
            <strong>The right to erasure</strong> – You have the right to
            request that Saas UI B.V. erase your personal data, under certain
            conditions.
          </p>
          <p>
            <strong>The right to restrict processing</strong> – You have the
            right to request that Saas UI B.V. restrict the processing of your
            personal data, under certain conditions.
          </p>
          <p>
            <strong>The right to object to processing</strong> – You have the
            right to object to Saas UI B.V.’s processing of your personal data,
            under certain conditions.
          </p>
          <p>
            <strong>The right to data portability</strong> – You have the right
            to request that Saas UI B.V. transfer the data that we have
          ...
          <p>
            Saas UI B.V. uses cookies in a range of ways to improve your
          ...
          <ul>
            <li>
              Functionality – Saas UI B.V. uses these cookies so that we
          ...
          <p>
            The Saas UI B.V. website contains links to other websites. Our
          ...
          <p>
            Saas UI B.V. keeps its privacy policy under regular review and
            places any updates on this web page. This privacy policy was last
            updated on 21 July 2023.
          </p>
          <h3>How to contact us</h3>
          <p>
            If you have any questions about Saas UI B.V.’s privacy policy, the
