...
export const propertyTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { propertyAnatomy } from './components/property'

export const theme = extendTheme({
  components: { SuiProperty: propertyAnatomy },
})
```
...
<Property variant="custom"> ... </Property>
```
