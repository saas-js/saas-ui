...
To create custom colors for your theme you can use the Saas UI [Palette generator](https://palette.saas-ui.dev), [Themera](https://themera.vercel.app/) or create and export color palettes in Figma with [SupaPalette](https://gumroad.com/a/507971507/pucdw).
