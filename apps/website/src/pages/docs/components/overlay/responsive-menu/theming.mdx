...
The `ResponsiveMenu` component is a multipart component. The styling needs to be
...
```jsx live=false
import { responsiveMenuAnatomy } from '@saas-ui/theme/anatomy'
import { createMultiStyleConfigHelpers } from '@chakra-ui/react'

const { definePartsStyle, defineMultiStyleConfig } =
  createMultiStyleConfigHelpers(responsiveMenuAnatomy.keys)
```
...
export const responsiveMenuTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { responsiveMenuAnatomy } from './components/responsive-menu'

export const theme = extendTheme({
  components: { SuiResponsiveMenu: responsiveMenuAnatomy },
})
```
...
<ResponsiveMenu size="xl"> ... </ResponsiveMenu>
```
...
export const responsiveMenuTheme = defineMultiStyleConfig({
  variants: { custom },
})

// Now we can use the new `custom` variant
<ResponsiveMenu variant="custom"> ... </ResponsiveMenu>
```
