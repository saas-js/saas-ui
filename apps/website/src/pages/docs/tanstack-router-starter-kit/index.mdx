---
title: TanStack Router (SPA) starter kit
description: A premium TanStack Router starter kit for SaaS and B2B projects with a focus on design, accessibility, and development speed.
---

## Introduction

The TanStack Router starter kit is a premium starter kit that is designed to help you build beautiful, intuitive web applications with speed.
...
This starter kit is a classic single page application (SPA), but with modern tooling.
It's built with Vite and TanStack Router, and is a great choice if you don't want to deal with the complexity of RSC and want the best possible (dev) performance.
...
- **Auth providers**: Easily switch between different authentication providers. Better Auth is the default.
