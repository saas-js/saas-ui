...
The `Page` component is a multipart component. The styling needs to be
...
```jsx live=false
import { pageAnatomy } from '@saas-ui/theme/anatomy'
...
export const pageTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { pageAnatomy } from './components/page'

export const theme = extendTheme({
  components: { SuiPage: pageAnatomy },
})
```
