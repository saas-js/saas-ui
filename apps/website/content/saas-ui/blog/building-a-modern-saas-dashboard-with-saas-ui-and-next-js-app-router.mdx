...
- `@saas-ui/cli`: installs the preset and user-owned Saas UI templates.
...
import { FiBarChart, FiHome, FiSettings, FiSidebar, FiUsers } from 'react-icons/fi'
...
export function SidebarLayout({ children }) {
  return (
    <AppShell
      ...
      sidebar={
        <Sidebar.Provider>
          <Sidebar.Root width="25%" bg="gray.100">
            <Sidebar.Header>
              <Sidebar.Trigger asChild>
                <IconButton aria-label="Toggle sidebar" variant="ghost">
                  <FiSidebar />
                </IconButton>
              </Sidebar.Trigger>
              ...
              <Menu.Trigger asChild>
                <IconButton aria-label="User menu" variant="ghost">
                  <Persona.Root presence="online">
                    <Persona.Avatar size="xs" name="John Doe" />
                  </Persona.Root>
                </IconButton>
              </Menu.Trigger>
              <Menu.Content>
          ...
          <Sidebar.Body flex="1" overflowY="auto">
            <Sidebar.Group>
              <Sidebar.GroupContent>
                <Sidebar.NavItem>
                  <Sidebar.NavButton><FiHome /> Home</Sidebar.NavButton>
                </Sidebar.NavItem>
                <Sidebar.NavItem>
                  <Sidebar.NavButton active><FiUsers /> Users</Sidebar.NavButton>
                </Sidebar.NavItem>
                <Sidebar.NavItem>
                  <Sidebar.NavButton><FiBarChart /> Analytics</Sidebar.NavButton>
                </Sidebar.NavItem>
                <Sidebar.NavItem>
                  <Sidebar.NavButton><FiSettings /> Settings</Sidebar.NavButton>
                </Sidebar.NavItem>
              </Sidebar.GroupContent>
            </Sidebar.Group>
          </Sidebar.Body>
...
- The installed _Sidebar_ template exposes `Sidebar.Header`, `Sidebar.Body`,
  and `Sidebar.Footer` parts for the logo, account menu, navigation, and color
  mode action.
- `Sidebar.Trigger` toggles the Sidebar on mobile and tablet devices.
- Navigation entries compose `Sidebar.NavItem` and `Sidebar.NavButton`. The
  _children_ prop is provided
  inside the _Box_ component to display the child elements.
- The installed `Persona.Avatar` component displays the user's profile image.
  You can provide
...
- For an accessible dropdown menu that is Tab navigable, the installed `Menu`
  composition exposes `Menu.Trigger`, `Menu.Content`, and `Menu.Item`. Check
    ...
    <AppShell
      ...
      sidebar={
        <Sidebar.Provider>
          ...
          <Sidebar.Footer alignItems="flex-start">
            <IconButton
...
The DataTable component is built using the Pro
[_DataGrid_ component](https://saas-ui.dev/docs/components/data-display/data-grid)
installed in the project. The component takes two props. One is for the
...
export function Summary({ currentUsersCount, oldUsersCount }) {
  return (
    <Box mb="8" w="full">
      ...
      >
        <GridItem>
          <Card.Root><Card.Body><Stat.Root>
            <Stat.Label>Total Users</Stat.Label>
            <Stat.ValueText>{currentUsersCount}</Stat.ValueText>
            <Stat.HelpText><Stat.UpTrend>80%</Stat.UpTrend></Stat.HelpText>
          </Stat.Root></Card.Body></Card.Root>
        </GridItem>
        <GridItem>
          <Card.Root><Card.Body><Stat.Root>
            <Stat.Label>New Users (Q3 23)</Stat.Label>
            <Stat.ValueText>{currentUsersCount - oldUsersCount}</Stat.ValueText>
            <Stat.HelpText>
              <Stat.UpTrend>
        ...
        <GridItem>
          <Card.Root><Card.Body><Stat.Root>
            ...
            <Stat.HelpText><Stat.UpTrend>78%</Stat.UpTrend></Stat.HelpText>
          </Stat.Root></Card.Body></Card.Root>
        </GridItem>
        <GridItem>
          <Card.Root><Card.Body><Stat.Root>
...
The Chakra UI
[`Timeline.Connector`](https://chakra-ui.com/docs/components/timeline)
part lets us customize the component/icon we want to use for each item, and
we'll use the
...
```tsx
import { Card, Heading, Text, Timeline } from '@chakra-ui/react'
import { Persona } from '#components/ui/persona/persona-composed'

export function Recent() {
  return (
    <Card.Root variant="solid" bg="transparent">
      <Card.Header pb="0">
      ...
      <Card.Body>
        <Timeline.Root variant="outline">
          <Timeline.Item>
            <Timeline.Connector>
              <Persona.Root presence="online">
                <Persona.Avatar name="Nicholas Runolfsdottir V" size="xs" />
              </Persona.Root>
            </Timeline.Connector>
            <Timeline.Content pt="2" px="3">
          ...
          <Timeline.Item>
            <Timeline.Connector>
              <Persona.Root presence="dnd">
                <Persona.Avatar name="Clementine Bauch" size="xs" />
              </Persona.Root>
            </Timeline.Connector>
            <Timeline.Content pt="2" px="3">
          ...
          <Timeline.Item>
            <Timeline.Connector>
              <Persona.Root presence="offline">
                <Persona.Avatar name="Leanne Graham" size="xs" />
              </Persona.Root>
            </Timeline.Connector>
            <Timeline.Content pt="2" px="3">
...
about it. Layout components like
[Page](https://saas-ui.dev/docs/components/page),
[Aside](https://saas-ui.dev/docs/components/aside), and
[Split Page](https://saas-ui.dev/docs/components/split-page) are available in
the public registry. Saas UI also provides a Pro license for advanced components
like
[Data Grid](https://saas-ui.dev/docs/pro/components/data-grid)
