...
```jsx height=400px overflow=hidden padding=0
import { Box } from '@chakra-ui/react'
import {
  AppShell,
  Sidebar,
...
Full example with Sidebar, Page <Badge variant="solid" colorScheme="primary" >Pro</Badge> and DataGrid <Badge variant="solid" colorScheme="primary">Pro</Badge>
