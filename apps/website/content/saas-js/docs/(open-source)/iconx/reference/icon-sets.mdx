...
- [CLI Reference](/packages/iconx/docs/reference/cli) - Complete command reference
- [Configuration](/packages/iconx/docs/reference/configuration) - Configure your project
