---
title: Saas UI theme tokens
description: The default Saas UI theme tokens
---

The Saas UI theme is loosely based on the excellent [Chakra UI theme](https://github.com/chakra-ui/chakra-ui/tree/main/packages/theme).
It has a neutral style that looks great out of the box.
The theme comes with a bunch of additions that make it easy to adjust it to your brand.
...
More information about [creating your custom palette](/docs/core/theming/customize-theme).
...
<ColorWrapper>
  ...
  <ColorPalettes color="secondary" name="Secondary" />
</ColorWrapper>
...
> Learn more about
> [Responsive Styles and Customizing Breakpoints](https://chakra-ui.com/docs/features/responsive-styles).
