...
Add a lightweight OKLCH appearance generator for base, accent, tonal sidebar,
...
appearance graph uses shared contrast axes and direct semantic formulas instead
of per-token profile and light/dark intermediate variables.
