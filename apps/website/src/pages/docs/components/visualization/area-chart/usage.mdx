...
id: aria-chart
title: Area Chart
description: An area chart is a visual representation that shows quantitative data as a series of points connected by straight line segments, filled below with color.
---

<ComponentLinks
  github={{ package: 'saas-ui-charts/src/area-chart.tsx' }}
