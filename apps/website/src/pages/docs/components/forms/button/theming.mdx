...
The `Button` component is a multipart component. The styling needs to be
...
```jsx live=false
import { buttonAnatomy } from '@saas-ui/theme/anatomy'
...
export const buttonTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { buttonAnatomy } from './components/button'

export const theme = extendTheme({
  components: { SuiButton: buttonAnatomy },
})
```
