...
The `saas-ui-pro-nextjs-starter-kit` repository is configured as the `upstream`
by default. To add your own repository as the `origin`, use the following
command:
...
As your codebase diverges from `saas-ui-pro-nextjs-starter-kit` you will run
