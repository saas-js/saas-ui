...
import { actionBarSlotRecipe } from '../components/action-bar/action-bar.recipe.ts'
...
import { blockquoteSlotRecipe } from '../components/blockquote/blockquote.recipe.ts'
...
import { editableSlotRecipe } from '../components/editable/editable.recipe.ts'
import { emptyStateSlotRecipe } from '../components/empty-state/empty-state.recipe.ts'
import { fieldSlotRecipe } from '../components/field/field.recipe.ts'
...
import { listSlotRecipe } from '../components/list/list.recipe.ts'
...
import { sliderSlotRecipe } from '../components/slider/slider.recipe.ts'
import { statSlotRecipe } from '../components/stat/stat.recipe.ts'
import { statusSlotRecipe } from '../components/status/status.recipe.ts'
import { stepsSlotRecipe } from '../components/steps/steps.recipe.ts'
import { switchSlotRecipe } from '../components/switch/switch.recipe.ts'
import { tableSlotRecipe } from '../components/table/table.recipe.ts'
import { tabsSlotRecipe } from '../components/tabs/tabs.recipe.ts'
import { tagSlotRecipe } from '../components/tag/tag.recipe.ts'
import { timelineSlotRecipe } from '../components/timeline/timeline.recipe.ts'
