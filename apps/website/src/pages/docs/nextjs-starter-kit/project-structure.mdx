...
| -------------------------- | -------------------- | ------------------------------------------------------------------------------------ |
| `saas-ui`                  | @saas-ui-pro/\*      | Saas UI Pro packages and components.                                                 |
...
| `packages/ui-lib`          | @ui/lib              | This is your shared UI library, and included all custom pre-built components         |
| `packages/ui-theme`        | @ui/theme            | Your custom Chakra UI theme. This extends the Saas UI Pro theme by default.          |
