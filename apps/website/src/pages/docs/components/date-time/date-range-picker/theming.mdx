...
The `DateRangePicker` component is a multipart component. The styling needs to be
...
```jsx live=false
import { dateRangePickerAnatomy } from '@saas-ui/theme/anatomy'
import { createMultiStyleConfigHelpers } from '@chakra-ui/react'

const { definePartsStyle, defineMultiStyleConfig } =
  createMultiStyleConfigHelpers(dateRangePickerAnatomy.keys)
```
...
export const dateRangePickerTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { dateRangePickerAnatomy } from './components/date-range-picker'

export const theme = extendTheme({
  components: { SuiDateRangePicker: dateRangePickerAnatomy },
})
```
...
<DateRangePicker size="xl"> ... </DateRangePicker>
```
...
export const dateRangePickerTheme = defineMultiStyleConfig({
  variants: { custom },
})

// Now we can use the new `custom` variant
<DateRangePicker variant="custom"> ... </DateRangePicker>
```
