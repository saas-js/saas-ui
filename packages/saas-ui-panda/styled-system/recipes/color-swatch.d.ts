...
export type ColorSwatchVariantProps = {
  [key in keyof ColorSwatchVariant]?: ConditionalValue<ColorSwatchVariant[key]> | undefined
}
...
export interface ColorSwatchRecipe {
  ...
  splitVariantProps<Props extends ColorSwatchVariantProps>(props: Props): [ColorSwatchVariantProps, Pretty<DistributiveOmit<Props, keyof ColorSwatchVariantProps>>]
