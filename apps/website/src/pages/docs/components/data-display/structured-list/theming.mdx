...
export const structuredListTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { structuredListAnatomy } from './components/structured-list'

export const theme = extendTheme({
  components: { SuiStructuredList: structuredListAnatomy },
})
```
...
<StructuredList size="xl"> ... </StructuredList>
```
...
<StructuredList variant="custom"> ... </StructuredList>
```
