...
1. **CSS knobs** on `.sui-theme` — the browser resolves
...
Use knobs for runtime theming (white-label, Storybook). Use
...
`--sui-base` / `--sui-accent`. If you also set those knobs, the baked tokens
