...
```jsx live=false
import { sectionAnatomy } from '@saas-ui/theme/anatomy'
...
export const sectionTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { sectionAnatomy } from './components/section'

export const theme = extendTheme({
  components: { SuiSection: sectionAnatomy },
})
```
...
export const sectionTheme = defineMultiStyleConfig({
  variants: { custom },
})

// Now we can use the new `custom` variant
<Section variant="custom"> ... </Section>
```
