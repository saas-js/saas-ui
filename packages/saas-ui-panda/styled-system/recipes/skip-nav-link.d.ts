...
export type SkipNavLinkVariantProps = {
  [key in keyof SkipNavLinkVariant]?: ConditionalValue<SkipNavLinkVariant[key]> | undefined
}
...
export interface SkipNavLinkRecipe {
  ...
  splitVariantProps<Props extends SkipNavLinkVariantProps>(props: Props): [SkipNavLinkVariantProps, Pretty<DistributiveOmit<Props, keyof SkipNavLinkVariantProps>>]
