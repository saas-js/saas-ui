...
Always preview icons at [icon-sets.iconify.design](https://icon-sets.iconify.design/) to ensure they match your design needs.

## Finding Icons

### Search Methods

1. **Browse by Set:** [icon-sets.iconify.design](https://icon-sets.iconify.design/)
...
- [Configuration](/docs/saas-js-iconify/reference/configuration) - Configure your project
