...
Check out the [react-table documentation](https://react-table.tanstack.com/docs/api/useTable#instance-properties) for all properties.
...
function TableState() {
  ...
  return (
    <Box overflowX="auto">
      <Button
        onClick={() => tableRef.current.toggleAllRowsSelected()}
