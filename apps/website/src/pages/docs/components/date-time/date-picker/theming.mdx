...
The `DatePicker` component is a multipart component. The styling needs to be
...
```jsx live=false
import { datePickerAnatomy } from '@saas-ui/theme/anatomy'
...
export const datePickerTheme = defineMultiStyleConfig({ baseStyle })
```
...
import { datePickerAnatomy } from './components/date-picker'

export const theme = extendTheme({
  components: { SuiDatePicker: datePickerAnatomy },
})
```
...
<DatePicker variant="custom"> ... </DatePicker>
```
