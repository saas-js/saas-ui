...
import { ResizeHandle, SortIndicator } from './data-table-cells.tsx'
import {
  getColumnWindow,
...
import type { DataTableVariantProps } from './data-table.recipe.ts'
import { type DataTableSize, dataAttr, escapeId } from './data-table.utils.ts'
